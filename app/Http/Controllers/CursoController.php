...
class CursoController extends Controller
{
    ...
    {
        //traemos toda la informacion de la tabla curso a través del modelo y el método all()
        $cursito = Curso::all();
    ...
    {
        $cursito = new Curso(); //Crear instancia de la clase Curso
        ...
        $cursito->save(); /*con el comando save se registra en la base de datos*/
